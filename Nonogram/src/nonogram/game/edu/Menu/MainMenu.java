...
public class MainMenu extends Application {
    ...
    public void start(Stage primaryStage){
        ...
        Button buttonPowrotdoMenu1 = new Button("Powr髏 do Menu");
        buttonPowrotdoMenu1.setOnAction(e -> window.setScene(MenuScene));
        Button buttonWyborRozmiaru = new Button("Wyb髍 w砤snego obrazka");
        ...
        Button buttonPowrotdoMenu2 = new Button("Powr贸t do Menu");
        ...
        Button buttonPowrotdoMenu3 = new Button("Powr贸t do Menu");
        ...
        Button buttonPowrotdoMenu4 = new Button("Powr贸t do Menu");
        ...
        //Layout 6 Wyb贸r rozmiaru planszy
        ...
        Button buttonPowrotdoMenu5 = new Button("Powr贸t do Menu");
        ...
        Button buttonPowrotdoMenu6 = new Button("Powr贸t do Menu");
        ...
        Button buttonPowrotdoMenu7 = new Button("Powr贸t do Menu");
